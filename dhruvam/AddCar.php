...
if($result = mysqli_query($link, $sql)){
    ...
    if(mysqli_num_rows($result) > 0){
         ...
         while($row = mysqli_fetch_array($result)){
         	...
         	$row["cspace"] = $row["cspace"] - 1;
         	$sql = "UPDATE space SET cspace=" . $row["cspace"]. " WHERE id='1'";
        ...
        elseif ($row["cspace"] == 0) {
         ...
         while($row = mysqli_fetch_array($result)){ 
         	...
         	$row["cspace"] = $row["cspace"] - 1;
         	$sql = "UPDATE space SET cspace=" . $row["cspace"]. " WHERE id='3'";
        ...
        elseif ($row["cspace"] == 0) {
         ...
         while($row = mysqli_fetch_array($result)){
         	...
         	$row["cspace"] = $row["cspace"] - 1;
         	$sql = "UPDATE space SET cspace=" . $row["cspace"]. " WHERE id='5'";
